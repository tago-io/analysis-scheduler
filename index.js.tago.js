...
/***/ function(module, exports, __webpack_require__) {
	...
	var Analysis = __webpack_require__(1);
	var Utils = __webpack_require__(118);
	var Device = __webpack_require__(120);
	var converter = __webpack_require__(121);
	var axios = __webpack_require__(5);
	var co = __webpack_require__(163);
	var url_node = __webpack_require__(29);

	function check_url(url) {
	    if (url.indexOf('docs.google.com') === -1 && url.indexOf('spreadsheets') === -1) return url;
	    var parse_url = url_node.parse(url);
	    var pathname = parse_url.pathname.split("/");
	    pathname = pathname.find(function (x) {
	        return x.length >= 25;
	...
	function convert_to_json(data_csv) {
	    return new Promise(function (resolve, reject) {
	        ...
	        converter.csv2json(data_csv, options, function (err, result) {
	...
	function run_scheduler(context) {
	    ...
	    var env_var = Utils.env_to_obj(context.environment);
	    ...
	    var mydevice = new Device(env_var.device_token);

	    co(regeneratorRuntime.mark(function _callee() {
	        var url, request, data_list, stepnow, data, serie, location, color, time, format_var, data_to_insert;
	        return regeneratorRuntime.wrap(function _callee$(_context) {
	            while (1) {
	                switch (_context.prev = _context.next) {
	                    case 0:
	                        format_var = function format_var(variable, value) {
	                            var data_to_insert = {
	                                "variable": variable,
	                                "value": value,
	                                "serie": serie
	                            ...
	                            if (color) data_to_insert.metadata = { color: color };

	                            return data_to_insert;
	                        };

	                        url = check_url(env_var.url);
	                        _context.next = 4;
	                    ...
	                    case 4:
	                        ...
	                        return _context.abrupt('return', context.log("Can't access the URL"));

	                    case 7:
	                        _context.next = 9;
	                        return convert_to_json(request.data);

	                    case 9:
	                        data_list = _context.sent;
	                        _context.next = 12;
	                        return mydevice.find({ "variable": "stepnow", "query": "last_value" });

	                    case 12:
	                        stepnow = _context.sent;

	                        stepnow = stepnow[0] ? stepnow[0].value : 0;

	                        data = data_list[stepnow] ? data_list[stepnow] : data_list[0];
	                        serie = new Date().getTime();
	                        _context.next = 18;
	                        return transform_loc(data.location);
	                    ...
	                    case 18:
	                        ...
	                        ["time", "color"].forEach(function (x) {
	                            return delete data[x];
	                        });
	                        ...
	                        _context.next = 27;
	                        return mydevice.insert(data_to_insert);
	...
	module.exports = new Analysis(run_scheduler);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Realtime = __webpack_require__(55);

	var Analysis = function () {
	    function Analysis(analysis, token) {
	    ...
	    _createClass(Analysis, [{
	        key: 'run',
	        value: function run(environment, data, token) {
	            var tago_console = new Services(token).console;
	            function log() {
	        ...
	        key: 'local_runtime',
	        value: function local_runtime() {
	            var _this = this;

	            if (!this._token) {
	                throw 'To run locally, needs a token.';
	            }
	            var scon = new Realtime(this._token);
	            scon.connect = function () {
	                console.log('Connected on Tago.io.');
	                scon.get_socket.emit('register:analysis', _this._token);
	                scon.get_socket.on('register:analysis', function (result) {
	                    if (!result.status) {
	            ...
	            scon.get_socket.on('run:analysis', function (scopes) {
	                return scopes.forEach(function (x) {
	                    return _this.run(x.environment, x.data, _this._token);
	                });
	            });
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Currency = __webpack_require__(3);
	var Distance = __webpack_require__(48);
	var Email = __webpack_require__(49);
	var Geocoding = __webpack_require__(50);
	var SMS = __webpack_require__(51);
	var Socket = __webpack_require__(52);
	var Weather = __webpack_require__(53);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var default_headers = __webpack_require__(46);

	var Currency = function () {
	    function Currency(acc_token) {
	    ...
	    _createClass(Currency, [{
	        key: 'convert',
	        value: function convert(c_from, c_to) {
	            var url = config.api_url + '/analysis/services/currency/convert';
	            var method = 'post';
	            var data = { c_from: c_from, c_to: c_to };

	            var options = Object.assign({}, this.default_options, { url: url, method: method, data: data });
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function tago_request(request_options) {
	    return axios(request_options).then(function (result) {
	        if (!result.data) {
	...
	module.exports = {
		"_args": [
			[
				...
				"/home/vitorfdl/projects/tago-analysis-scheduler"
			]
		],
		"_from": "axios@latest",
		"_id": "axios@0.13.1",
		...
		"_shrinkwrap": null,
		"_spec": "axios",
		"_where": "/home/vitorfdl/projects/tago-analysis-scheduler",
		"author": {
			"name": "Matt Zabriskie"
		},
		"browser": {
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		"_npmOperationalInternal": {
			"host": "packages-12-west.internal.npmjs.com",
			"tmp": "tmp/tago-2.0.14.tgz_1471291644375_0.3541602222248912"
		},
		"_npmUser": {
			"name": "vitorfdl",
		...
		"_resolved": "https://registry.npmjs.org/tago/-/tago-2.0.14.tgz",
		"_shasum": "935962873bb560d0d25122a8ad146c8942b8ffa3",
		"_shrinkwrap": null,
		"_spec": "tago@^2.0.14",
		"_where": "/home/vitorfdl/projects/tago-analysis-scheduler",
		"author": {
		...
		"directories": {},
		"dist": {
			"shasum": "935962873bb560d0d25122a8ad146c8942b8ffa3",
			"tarball": "https://registry.npmjs.org/tago/-/tago-2.0.14.tgz"
		},
		"engines": {
			"node": ">=4.0.0"
		},
		"gitHead": "be42c5c3e19075ea07ccfb0932010472674ea103",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Distance = function () {
	    ...
	    _createClass(Distance, [{
	        key: 'measure',
	        value: function measure(origins, destinations, language, mode) {
	            var url = config.api_url + '/analysis/services/distance/measure';
	            var method = 'post';
	            var data = { origins: origins, destinations: destinations, language: language, mode: mode };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Email = function () {
	    ...
	    _createClass(Email, [{
	        key: 'send',
	        value: function send(to, subject, message, from) {
	            var url = config.api_url + '/analysis/services/email/send';
	            var method = 'POST';
	            var data = { to: to, subject: subject, message: message, from: from };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Geocoding = function () {
	    ...
	    _createClass(Geocoding, [{
	        key: 'get_address',
	        value: function get_address(address) {
	            var url = config.api_url + '/analysis/services/geocoding/get_address';
	            var method = 'POST';
	        ...
	        key: 'get_geolocation',
	        value: function get_geolocation(geolocation) {
	            var url = config.api_url + '/analysis/services/geocoding/get_geolocation';
	            var method = 'POST';
	...
	var SMS = function () {
	    ...
	    _createClass(SMS, [{
	        ...
	        value: function send(to, message) {
	            var url = config.api_url + '/analysis/services/sms/send';
	            var method = 'post';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Socket = function () {
	    ...
	    _createClass(Socket, [{
	        key: 'send',
	        value: function send(bucket_id, data_entry) {
	            var url = config.api_url + '/analysis/services/socket/send';
	            var method = 'post';
	            var data = { bucket_id: bucket_id, 'data': data_entry };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Weather = function () {
	    ...
	    _createClass(Weather, [{
	        ...
	        key: 'current',
	        value: function current(query, full, lang) {
	            this._setParams({ query: query, full: full, lang: lang });
	            var url = config.api_url + '/analysis/services/weather/current';
	            var method = 'POST';
	            var data = { 'query': this._query, 'full': this._full, 'lang': this._lang };
	        ...
	        key: 'history',
	        value: function history(date, query, full, lang) {
	            this._setParams({ query: query, full: full, lang: lang });
	            var url = config.api_url + '/analysis/services/weather/history';
	            var method = 'POST';
	            var data = { 'query': this._query, 'full': this._full, 'lang': this._lang, date: date };
	        ...
	        key: 'forecast',
	        value: function forecast(query, full, lang) {
	            this._setParams({ query: query, full: full, lang: lang });
	            var url = config.api_url + '/analysis/services/weather/forecast';
	            var method = 'POST';
	            var data = { 'query': this._query, 'full': this._full, 'lang': this._lang };
	        ...
	        key: 'alerts',
	        value: function alerts(query, full, lang) {
	            this._setParams({ query: query, full: full, lang: lang });
	            var url = config.api_url + '/analysis/services/weather/alerts';
	            var method = 'POST';
	            var data = { 'query': this._query, 'full': this._full, 'lang': this._lang };
	...
	var Console = function () {
	    ...
	    _createClass(Console, [{
	        ...
	        value: function log(message) {
	            var url = config.api_url + '/analysis/services/console/send';
	            var method = 'post';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var socketclient = __webpack_require__(56);
	var config = __webpack_require__(45);
	var options = {
	...
	var Realtime = function () {
	    function Realtime(token) {
	        ...
	        this.socket.on('connect', function () {
	            _this.socket.emit('register', _this.token);
	        });

	        this.socket.on('reconnecting', function () {
	            return console.log('Trying to reestablish connection.');
	        });
...
/***/ function(module, exports) {
	...
	function env_to_obj(environment) {
	    return environment.reduce(function (pv, cv) {
	        pv[cv.key] = cv.value;
	        return pv;
	    }, {});
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var config = __webpack_require__(45);
	var default_headers = __webpack_require__(46);
	var Realtime = __webpack_require__(118).realtime;
	...
	var Device = function () {
	    ...
	    _createClass(Device, [{
	        key: 'info',
	        value: function info() {
	            var url = config.api_url + '/info';
	            var method = 'GET';

	            var options = Object.assign({}, this.default_options, { url: url, method: method });
	            return request(options);
	        }
	        ...
	        key: 'find',
	        value: function find(query_obj) {
	            query_obj = query_obj || {};
	            var url = config.api_url + '/data';
	            var method = 'GET';
	            var params = Object.assign({}, this.default_options.qs || {}, query_obj);

	            var options = Object.assign({}, this.default_options, { url: url, method: method, params: params });
	        ...
	        key: 'remove',
	        value: function remove(variable_or_id, qty) {
	            var url = config.api_url + '/data';
	            if (variable_or_id) {
	                url += '/' + variable_or_id;
	            }

	            var params = Object.assign({}, this.default_options.qs || {}, qty ? { qty: qty } : {});
	            var method = 'DELETE';
	        ...
	        */
	        ...
	        value: function get_params() {
	            var url = config.api_url + '/device/params';
	            var method = 'GET';
	            var options = Object.assign({}, this.default_options, { url: url, method: method });
	            return request(options);
	        }
	        ...
	        key: 'mark_param',
	        value: function mark_param(key_name) {
	            var url = config.api_url + '/device/params/' + encodeURIComponent(key_name);
	            var method = 'PUT';
	            var options = Object.assign({}, this.default_options, { url: url, method: method });
	            return request(options);
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var copyOption = function copyOption(options, lowercasePath, uppercasePath) {
	 ...
	 */
	var buildOptions = function buildOptions(opts, cb) {
	...
	module.exports = {
	     ...
	     */
	    json2csv: function json2csv(array, callback, opts) {
	     ...
	     * @param opts
	     */
	    csv2json: function csv2json(csv, callback, opts) {
	        // If this was promisified (callback and opts are swapped) then fix the argument order.
	        if (_.isObject(callback) && !_.isFunction(callback)) {
	            var func = opts;
	            opts = callback;
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @returns {promise}
	 */
	var generateHeading = function generateHeading(data) {
	    if (options.KEYS) {
	 ...
	 * @returns {Array}
	 */
	var generateDocumentHeading = function generateDocumentHeading(heading, data) {
	 ...
	 * @returns {Array}
	 */
	var convertData = function convertData(data, keys) {
	 ...
	 * @param output
	 */
	var convertField = function convertField(value) {
	    if (_.isArray(value)) {
	 ...
	 * @returns {*}
	 */
	var generateCsv = function generateCsv(data, headingKeys) {
	...
	module.exports = {
	     ...
	     */
	    json2csv: function json2csv(opts, data, callback) {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @returns {*}
	 */
	var retrieveHeading = function retrieveHeading(lines, callback) {
	 ...
	 * @returns {boolean}
	 */
	var isArrayRepresentation = function isArrayRepresentation(value) {
	 ...
	 * @returns {Array}
	 */
	var convertArrayRepresentation = function convertArrayRepresentation(arrayRepresentation) {
	 ...
	 */
	var createDocument = function createDocument(keys, line) {
	 ...
	 * @returns {Array}
	 */
	var convertCSV = function convertCSV(lines, callback) {
	 ...
	 * @param line
	 */
	var splitLine = function splitLine(line) {
	...
	module.exports = {
	     ...
	     * @param callback Function callback function
	     */
	    csv2json: function csv2json(opts, data, callback) {
	        // If a callback wasn't provided, throw an error
	        if (!callback) {
	            throw new Error(constants.Errors.callbackRequired);
	        }
